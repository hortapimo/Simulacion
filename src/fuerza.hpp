...
Vector2D calcularFuerzaPar1_R2(Particle, Particle);
Vector2D calcularFuerzaParElectrica(Particle, Particle);
Vector2D calcularFuerzaParDeLennorJones(Particle, Particle);
Vector2D calcularFuerzaPar_SinFuerza(Particle, Particle);
...
Vector2D calcularFuerzaPar1_R2(Particle p1, Particle p2){
    Vector2D aux;
